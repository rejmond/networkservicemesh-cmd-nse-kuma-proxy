...
type Config struct {
	Name                  string            `default:"kuma-proxy-server" desc:"Name of Kuma Proxy Server"`
	BaseDir               string            `default:"./" desc:"base directory" split_words:"true"`
	ConnectTo             url.URL           `default:"unix:///var/lib/networkservicemesh/nsm.io.sock" desc:"url to connect to" split_words:"true"`
	MaxTokenLifetime      time.Duration     `default:"10m" desc:"maximum lifetime of tokens" split_words:"true"`
	ServiceNames          []string          `default:"kuma-proxy-responder" desc:"Name of provided services" split_words:"true"`
